...
<acme:form>
	<acme:form-textbox code="authenticated.worker.form.label.qualificationRecord" path="qualificationRecord"/>
	<acme:form-textbox code="authenticated.worker.form.label.skillRecord" path="skillRecord"/>
